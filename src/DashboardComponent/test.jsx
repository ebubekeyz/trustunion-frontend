...
then close all select boxes: */
  ...
  <legend className="fieldset-label">Select Bank</legend>
  <select defaultValue="" className="select" name="bank" id="ms">
          ...
          <article className="to">
            <div>
              <h4>Transfer To:</h4>
               <div> <label className="fieldset-label" >Beneficiary Account Number</label>
          <input type="text" className="input" defaultValue=''   name="accountNumber"  id="acc"/></div>

              
            <div> <label className="fieldset-label" >Routing Number</label>
          <input type="text" className="input" defaultValue=''   name="routingNumber"  id="routingNumber"/></div>

              

              <div className="input-show" style={{ width: '100%' }}>

                <div> <label className="fieldset-label" >Account Name</label>
          <input type="text" className="input" defaultValue=''   name="accountName"  id="accountName"/></div>
...
<fieldset className="fieldset">
  <legend className="fieldset-label">Select Bank</legend>
  <select defaultValue="" className="select" name="user" id="ms">
...
<div> <label className="fieldset-label" >Date1</label>
          <input type="text" className="input" defaultValue='' name="date1"  placeholder="12th June 2024"/></div>


              
              <div> <label className="fieldset-label" >Date2</label>
          <input type="text" className="input" defaultValue='' name="date2"  placeholder="11:57am, 12/06/2024"/></div>
          ...
          {show ? (
            <div>
              ...
              <div> <label className="fieldset-label" >Amount</label>
          <input type="text" className="input" defaultValue='' name="amount"  placeholder="Amount"/></div>
            
              
               <div> <label className="fieldset-label" >Narration</label>
          <input type="text" className="input" defaultValue='' name="narration"  /></div>
              ...
              <div className="">
                ...
                <div className="popup">
                  <h4>Transfer Pin</h4>
                   ...
                   <div> <label className="fieldset-label" >Enter your pin</label>
          <input type="text" className="input otp" defaultValue='' id="pin"  /></div>
                  
                  <button className="btn btn-primary" onClick={clickPin}>
                    Send
                  </button>
                </div>
              </div>
